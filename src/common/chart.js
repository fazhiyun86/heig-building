 ...
 * */
$(function() {
	var data1 = [{value: 335,name: '住宅'},{value: 310,name: '商场'},{value: 234,name: '商住楼'},{value: 135,name: '综合楼'},{value: 548,name: '办公科研楼'},{value: 310,name: '宾馆旅馆'},{value: 234,name: '医院'},{value: 135,name: '教学楼'},{value: 548,name: '工业建筑'},{value: 548,name: '仓库'},{value: 548,name: '其它'}];
	//调用饼图1(建筑性质)
	Charts._peiOne(data1,'chart1');
	
	var data2 = [{value: 335,name: '木结构'},{value: 310,name: '砖木结构'},{value: 234,name: '砖混结构'},{value: 135,name: '钢筋混凝土'},{value: 548,name: '钢结构'},{value: 310,name: '其它结构'}];
	//调用饼图2（建筑结构）
